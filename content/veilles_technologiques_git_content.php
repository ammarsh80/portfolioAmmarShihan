...
<section>
    ...
    <section class="veille">
        <article>
            ...
            <img src="./assets/img/img_veille_git/1.png" alt="instalation Git" class="veille1_img1">
            ...
            <img src="./assets/img/img_veille_git/2.png" alt="compte GitHub" class="veille1_img1">
            ...
            <img src="./assets/img/img_veille_git/3.png" alt="connexion à GitHub" class="veille1_img1">
            ...
            <img src="./assets/img/img_veille_git/4.png" alt="créer un repositorie sur GitHub" class="veille1_img1">
            ...
            <img src="./assets/img/img_veille_git/5.png" alt="consulter ses repositories" class="veille1_img1">
            <p>Pour partager un seul repository : copier partager ce lien (dans code). </p>
            <img src="./assets/img/img_veille_git/6.png" alt="copier le lien d'un repositorie" class="veille1_img1">
            <img src="./assets/img/img_veille_git/7.png" alt="information sur un repositorie" class="veille1_img1">
            ...
            <img src="./assets/img/img_veille_git/8.png" alt="onglet paramettres" class="veille1_img1">
            ...
            <img src="./assets/img/img_veille_git/9.png" alt="paramettre sensibles sur GitHub" class="veille1_img1">
            ...
            <img src="./assets/img/img_veille_git/10.png" alt="ouvrir git Bash" class="veille1_img1">
            ...
            <img src="./assets/img/img_veille_git/11.png" alt="git Bash" class="veille1_img1">
            <p>La branche est créée.
                Pour l’absorber (par un collaborateur) :
            </p>
            <img src="./assets/img/img_veille_git/12.png" alt="notion des branches sur gitHub" class="veille1_img1">
            ...
            <img src="./assets/img/img_veille_git/13.png" alt="merge dev" class="veille1_img1">
            <p>Avec encore, la commande</p>
            <p class="commande_git"> git merge</p>
            <p> cette fois pour envoyer le projet de la branche dev à la branche master</p>
            <img src="./assets/img/img_veille_git/14.png" alt="merge sur branche master" class="veille1_img1">
            <p> Fin du projet</p>
